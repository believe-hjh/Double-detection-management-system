...
public class ScmSaleCustomerController extends BaseController
{
    ...
    @PreAuthorize("@ss.hasPermi('scm:customer:export')")
    ...
    @PreAuthorize("@ss.hasPermi('scm:customer:add')")
    ...
    @PreAuthorize("@ss.hasPermi('scm:customer:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('scm:customer:remove')")
